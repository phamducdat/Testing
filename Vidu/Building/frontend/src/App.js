...
class App extends Component {
    ...
    this.setState(
      ...
      () => {
        ...
        this.getToken().then((token) => {
          ...
          console.log("token in joinSession is" + token);
  ...
  createToken() {
    return new Promise((resolve, reject) => {
      ...
      UserService.getSession(this.state.mySessionId)
        .then((response) => {
